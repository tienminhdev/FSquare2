...
/**
 * Created by TIEN on 24/08/2016.
 */
public class ChatAdapter extends FirebaseRecyclerAdapter<ChatModel,ChatAdapter.MyChatViewHolder> {
    ...
    public ChatAdapter(DatabaseReference ref, String nameUser, ClickListenerChatFirebase mClickListenerChatFirebase) {
        super(ChatModel.class, R.layout.item_message_left, ChatAdapter.MyChatViewHolder.class, ref);
    ...
    protected void populateViewHolder(MyChatViewHolder viewHolder, ChatModel model, int position) {
        ...
        if (model.getFile() != null){
            ...
            viewHolder.setIvChatPhoto(dev.tienminh.fsquare.util.Util.local(model.getMapModel().getLatitude(),model.getMapModel().getLongitude()));
